...
"[project]/Documents/trae_projects/flow4network/src/app/api/admin/tests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const total = await prisma.testLink.count({
            where
        });
...
async function PATCH(request) {
    try {
        ...
        if (action === 'TOGGLE_STATUS') {
            ...
            if (!link) return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$trae_projects$2f$flow4network$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Not found'
            }, {
                status: 404
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a587fed._.js.map